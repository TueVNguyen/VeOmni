...
def fused_linear_cross_entropy_forward(
    ...
    grad_weight = torch.zeros_like(weight, device=device, dtype=torch.float32) if weight.requires_grad else None
    ...
    for chunk_id in range(num_chunks):
        ...
        grad_input[start_idx:end_idx] = grad_logits_chunk.float() @ weight.float()
