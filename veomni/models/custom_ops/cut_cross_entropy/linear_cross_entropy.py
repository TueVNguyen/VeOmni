...
from veomni.models.custom_ops.cut_cross_entropy.cce_utils import CCEPreset, CCEPresets, LinearCrossEntropyImpl
from veomni.models.custom_ops.cut_cross_entropy.constants import IGNORE_INDEX
from veomni.models.custom_ops.cut_cross_entropy.doc import CCE_OPTS_DOC, IMPL_DOC, LINEAR_CROSS_ENTROPY_DOC, add_doc_start
from veomni.models.custom_ops.cut_cross_entropy.torch_compile import torch_compile_linear_cross_entropy
from veomni.models.custom_ops.cut_cross_entropy.utils import is_torch_greater_or_equal_2_5
...
if TYPE_CHECKING or PLATFORM_SYSTEM != "Darwin":
    from veomni.models.custom_ops.cut_cross_entropy.cce import cce_linear_cross_entropy
