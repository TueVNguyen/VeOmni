...
from veomni.models.custom_ops.cut_cross_entropy.doc import LINEAR_CROSS_ENTROPY_DOC, add_doc_start
from veomni.models.custom_ops.cut_cross_entropy.utils import (
    _build_flat_valids,
    handle_reduction_none,
    softcapping,
)
from veomni.models.custom_ops.cut_cross_entropy.vocab_parallel import (
